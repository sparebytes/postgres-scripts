...
SELECT DISTINCT
	fk."constraint_name",
	( r.TABLE_SCHEMA || '.' || r.TABLE_NAME ) AS "fTable",
	array_to_string( ARRAY_AGG ( r.COLUMN_NAME ), ',' ) AS "fColumns",
	( u.TABLE_SCHEMA || '.' || u.TABLE_NAME ) AS "pTable",
	array_to_string( ARRAY_AGG ( u.COLUMN_NAME ), ',' ) AS "pColumns" 
FROM
